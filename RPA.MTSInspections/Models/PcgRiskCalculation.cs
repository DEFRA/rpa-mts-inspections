...
{
    public class PcgRiskCalculation : RiskCalculation
    {
        ...
        protected override bool IsPlantOptionValid(List<PlantOption> plantOption)
        {
            ...
            probe = plantOption.Where(x => x.Option.Criteria.Name == "Probe").FirstOrDefault();
            ...
            if (throughput != null && opHours != null && preSignIn != null && recKeep != null && lineClear != null && probe != null && trimming != null && carcassDress != null
        ...
        public override int Calculation(List<PlantOption> plantOption)
        {
            ...
            int probeScore = probe.Option.Score * probe.Option.Criteria.Weighting;
            ...
            int FinalPlantScore = ThroughputScore + OpHoursScore + preSignInScore + recKeepScore + lineClearScore + probeScore + trimmingScore + carcassDressScore;
