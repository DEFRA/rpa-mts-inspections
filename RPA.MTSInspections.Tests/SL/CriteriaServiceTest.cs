...
{
    [TestFixture]
    [Category("Criteria Service")]
    public class CriteriatServiceTest
    {
        ...
        public void Setup()
        {
            ...
            service = new CriteriaService(mockContext.Object);
        }

        [Test]
        public void Test_GetBlsCriteria()
        {
            //Arrange
            //Already Done in Setup

            //Act
            var result = service.GetBlsCriteria();
        ...
        [Test]
        public void Test_GetBccCriteria()
        {
            //Arrange
            //Already Done in Setup

            //Act
            var result = service.GetBccCriteria();
        ...
        [Test]
        public void Test_GetPcgCriteria()
        {
            //Arrange
            //Already Done in Setup

            //Act
            var result = service.GetPcgCriteria();
        ...
        public void Test_GetBLSSelectCriteria_ReturnsList()
        {
            //Arrange
            //Already Done in Setup

            //Act
            var result = service.GetBlsSelectCriteria();
        ...
        [Test]
        public void Test_GetBCCSelectCriteria_ReturnsList()
        {
            //Arrange
            //Already Done in Setup

            //Act
            var result = service.GetBccSelectCriteria();

            //Assert
            Assert.AreEqual(15, result.Count);
        }
        [Test]
        public void Test_GetPCGSelectCriteria_ReturnsList()
        {
            //Arrange
            //Already Done in Setup

            //Act
            var result = service.GetPcgSelectCriteria();
