...
namespace RPA.MTSInspections.Tests.SL
{
    ...
    public class ExportServiceTest
    {
        ...
        public void Setup()
        {
            ...
            var lastInspDate2 = new LastInspection { PlantId = Guid.Parse("C741904A-5C65-4D12-848D-284BF2D4AF79"), SchemeId = Guid.Parse("5982F25B-4DDE-483C-B0D3-F2E46A5036B4"), Date = new DateTime(2017, 05, 01) };
            ...
            service = new ExportService(mockContext.Object, Sservice.Object, Aservice.Object);

        }

        [Test]

        public void Test_GetMyCollection_Returns_List()
        {
            //Arrange
            ...
            var result = service.GetMyCollection();
        ...
        public void Test_Convert_List_To_String_Returns_a_string()
        {
            //Arrange
            ...
            var result = service.ConvertListToString("1");
        ...
        [Test]
        public void Test_AddTableData_AddsData()
        {
            //Arrange

            string tableName = "BCC";

            DataTable BulkSource = new DataTable("BulkSource");

            BulkSource.TableName = tableName;

            BulkSource.Columns.Add("Lic Number");
            BulkSource.Columns.Add("Scheme Year");
            BulkSource.Columns.Add("date of last inspection");
            BulkSource.Columns.Add("Latest inspection outcome");
            BulkSource.Columns.Add("Failed / Unsatisfactory / on last visit ");
            BulkSource.Columns.Add("Total Near Misses in last 3 yrs");
            BulkSource.Columns.Add("No. Unsat / Fails in last 3 yrs");
            ...
            service.AddTableData(rw, tableName);

            //Assert

            mockPlantOptionSet.Verify(x => x.Add(It.IsAny<PlantOption>()), Times.AtLeastOnce);
        }
