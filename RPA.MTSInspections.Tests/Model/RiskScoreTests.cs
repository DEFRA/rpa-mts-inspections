...
namespace RPA.MTSInspections.Tests.Model
{
    public class RiskScoreTests
    {
        List<PlantOption> plantOptionsData;
        ...
        public void Setup()
        {
            ...
            plantOptionsData = new List<PlantOption>
            {
        ...
        public void Test_BLSRiskSscore_Calculates_Correct_Score()
        {
            //Arrange
            BlsRiskCalculation blsCalc = new BlsRiskCalculation();

            //Act
            var result = blsCalc.Calculation(plantOptionsData.Where(x => x.Scheme.Name == "BLS").ToList());
        ...
        [Test]
        public void Test_BCCRiskSscore_Calculates_Correct_Score()
        {
            //Arrange
            BccRiskCalculation bccCalc = new BccRiskCalculation();

            //Act
            var result = bccCalc.Calculation(plantOptionsData.Where(x => x.Scheme.Name == "BCC").ToList());
        ...
        [Test]
        public void Test_PCGRiskSscore_Calculates_Correct_Score()
        {
            //Arrange
            PcgRiskCalculation pcgCalc = new PcgRiskCalculation();

            //Act
            var result = pcgCalc.Calculation(plantOptionsData.Where(x => x.Scheme.Name == "PCG").ToList());

            //Assert

            Assert.AreEqual(1355, result);
